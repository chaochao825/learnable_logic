...
- `bitstate/`: strict persistent-Boolean successor with uint8 threshold encoding, 16-function gate layers, local logic, XNOR-popcount Top-K routing, bitwise-majority aggregation, Boolean merges, and integer GroupSum output.
