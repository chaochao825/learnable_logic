...
| bitplane_lut_spatial_argmax | screen | 24,576 protected CIFAR A8 bit planes plus class-vote 4-input LUT planes with fixed image-local candidate pools | eight Boolean planes per raw state symbol | block-wise hard-ST then direct argmax and hard freeze | bool LUT/wiring plus integer GroupSum | cifar100 21.82% on validation (screen); test 21.26% | strict CIFAR-100 seed-0 ceiling is 21.82% hard accuracy at v256-d4; 8x gates over spatial v64-d2 add 4.74 pp, while v128 d2-to-d4 adds only 0.08 pp and 4.07 pp unused gates; positive scaling is capacity-inefficient and not yet repeated |
...
| bitplane_lut_sequence_causal_argmax | candidate | 512 protected context planes plus character-vote 4-input LUT planes with recent-history and same-class recurrent candidates | eight Boolean planes per character ID | block-wise hard-ST then direct argmax and exact hard-prefix continuation | bool LUT/wiring plus integer GroupSum | tiny_shakespeare_char 40.81% on validation (screen); test 39.83% | three-seed v64-d4 validation hard accuracy is 40.213% +/- 0.248%, with a 3.972 pp mean depth gain and 3/3 wins over exact v64-d2 hard prefixes; v128-d4 reaches 40.815% on seed 0 but remains an unreplicated screen |
...
| bitplane_c100_mixed_v64_d2_s0 | bitplane_lut_argmax | cifar100 | bitplane_lut_cifar100_scale_s0_v1 | 0 | validation | 15.40% | 15.40% | 0.00% | 3.7436427310943605 | 3.7270684242248535 | 0.016574306869507005 | 15.52% | 3407.1639521020115 | 7.20% | 0.02% | 12800 | 2 | 12 | operator_audited_bool_int | baseline |
| bitplane_c100_spatial_v64_d2_s0 | bitplane_lut_spatial_argmax | cifar100 | bitplane_lut_cifar100_scale_s0_v1 | 0 | validation | 16.94% | 17.08% | 0.14% | 3.624477144241333 | 3.615676164627075 | 0.008800979614257631 | 16.94% | 4976.362019958004 | 6.65% | 0.09% | 12800 | 2 | 13 | operator_audited_bool_int | screen |
| bitplane_c100_spatial_v128_d2_s0 | bitplane_lut_spatial_argmax | cifar100 | bitplane_lut_cifar100_scale_s0_v1 | 0 | validation | 20.18% | 19.82% | 0.36% | 3.4527293045043947 | 3.454364061355591 | 0.001634756851196073 | 20.37% | 8823.485202446987 | 7.36% | 0.03% | 25600 | 2 | 14 | operator_audited_bool_int | screen |
| bitplane_c100_spatial_v128_d4_s0 | bitplane_lut_spatial_argmax | cifar100 | bitplane_lut_cifar100_scale_s0_v1 | 0 | validation | 20.68% | 19.90% | 0.78% | 3.4157996505737303 | 3.4327070713043213 | 0.01690742073059104 | 20.72% | 14492.501615523972 | 11.43% | 0.00% | 51200 | 4 | 14 | operator_audited_bool_int | screen |
| bitplane_c100_spatial_v256_d4_s0 | bitplane_lut_spatial_argmax | cifar100 | bitplane_lut_cifar100_scale_s0_v1 | 0 | validation | 21.84% | 21.82% | 0.02% | 3.351554071807861 | 3.332369089126587 | 0.01918498268127422 | 21.26% | 21303.45432932698 | 12.44% | 0.00% | 102400 | 4 | 20 | operator_audited_bool_int | screen |
...
| bitplane_shakespeare_causal_v128_d4_s0 | bitplane_lut_sequence_causal_argmax | tiny_shakespeare_char | bitplane_lut_shakespeare_char_scale_s0_v1 | 0 | validation | 40.80% | 40.81% | 0.01% | 2.1096577142715454 | 2.1340075515747072 | 0.02434983730316187 | 39.83% | 8890.181762669003 | 3.14% | 7.00% | 33280 | 4 | 238 | operator_audited_bool_int | screen |
| bitplane_shakespeare_causal_v64_d2_s0 | bitplane_lut_sequence_causal_argmax | tiny_shakespeare_char | bitplane_lut_shakespeare_char_depth_s012_v1 | 0 | validation | 36.41% | 36.27% | 0.14% | 2.3073506427764894 | 2.309064136123657 | 0.0017134933471676383 | 35.43% | 2728.7207847289974 | 4.01% | 7.76% | 8320 | 2 | 182 | operator_audited_bool_int | baseline |
| bitplane_shakespeare_causal_v64_d4_s0 | bitplane_lut_sequence_causal_argmax | tiny_shakespeare_char | bitplane_lut_shakespeare_char_depth_s012_v1 | 0 | validation | 39.94% | 39.93% | 0.00% | 2.1030938846588136 | 2.1175047687530517 | 0.014410884094238074 | 39.40% | 5309.371265493042 | 4.60% | 7.21% | 16640 | 4 | 182 | operator_audited_bool_int | screen |
| bitplane_shakespeare_causal_v64_d2_s1 | bitplane_lut_sequence_causal_argmax | tiny_shakespeare_char | bitplane_lut_shakespeare_char_depth_s012_v1 | 1 | validation | 35.73% | 36.18% | 0.45% | 2.3602095235824585 | 2.3219804191589355 | 0.03822910442352301 | 35.56% | 1888.6413842649781 | 3.65% | 9.62% | 8320 | 2 | 181 | operator_audited_bool_int | baseline |
| bitplane_shakespeare_causal_v64_d4_s1 | bitplane_lut_sequence_causal_argmax | tiny_shakespeare_char | bitplane_lut_shakespeare_char_depth_s012_v1 | 1 | validation | 40.23% | 40.29% | 0.06% | 2.1083071676254272 | 2.112770120048523 | 0.00446295242309569 | 39.63% | 4395.036057160993 | 4.75% | 6.85% | 16640 | 4 | 181 | operator_audited_bool_int | screen |
| bitplane_shakespeare_causal_v64_d2_s2 | bitplane_lut_sequence_causal_argmax | tiny_shakespeare_char | bitplane_lut_shakespeare_char_depth_s012_v1 | 2 | validation | 35.47% | 36.27% | 0.80% | 2.3325215648651123 | 2.3050187036514282 | 0.02750286121368406 | 35.47% | 1671.6000480949879 | 4.19% | 8.85% | 8320 | 2 | 170 | operator_audited_bool_int | baseline |
| bitplane_shakespeare_causal_v64_d4_s2 | bitplane_lut_sequence_causal_argmax | tiny_shakespeare_char | bitplane_lut_shakespeare_char_depth_s012_v1 | 2 | validation | 40.20% | 40.41% | 0.22% | 2.091716973876953 | 2.0985961694717408 | 0.006879195594787557 | 40.05% | 4040.6885148622096 | 4.67% | 6.20% | 16640 | 4 | 170 | operator_audited_bool_int | screen |
...
| bitplane_lut_argmax | c100_mixed_v64_d2 | 24576 | 24576 | 30976 | 1024000 | 1482240 | 12800 | 2 | 12 | fixed mixed candidate baseline; each final vote has at most 16 raw-input support leaves before repeated-source reduction |
| bitplane_lut_spatial_argmax | c100_spatial_v64_d2 | 24576 | 24576 | 30976 | 1024000 | 1482240 | 12800 | 2 | 13 | same gate budget as mixed baseline; fixed 3x3 raw probes and same-class recurrent vote candidates |
| bitplane_lut_spatial_argmax | c100_spatial_v128_d2 | 24576 | 24576 | 37376 | 2048000 | 2698240 | 25600 | 2 | 14 | 2x votes and gates versus v64 at the same Boolean depth; final support remains bounded by 16 leaves |
| bitplane_lut_spatial_argmax | c100_spatial_v128_d4 | 24576 | 24576 | 37376 | 4096000 | 4746240 | 51200 | 4 | 14 | same vote width as v128-d2 with 2x depth/gates and at most 256 raw-input support leaves per final vote |
| bitplane_lut_spatial_argmax | c100_spatial_v256_d4 | 24576 | 24576 | 50176 | 8192000 | 9123840 | 102400 | 4 | 20 | 2x votes versus v128-d4; largest pre-registered logic-native capacity point |
...
| bitplane_lut_sequence_causal_argmax | shakespeare_causal_v64_d4 | 512 | 512 | 4672 | 1331200 | 1202688 | 16640 | 4 | 182 | 2x Boolean depth at fixed vote width; scale is accepted only with validation hard-accuracy improvement |
| bitplane_lut_sequence_causal_argmax | shakespeare_causal_v128_d4 | 512 | 512 | 8832 | 2662400 | 2533888 | 33280 | 4 | 238 | largest pre-registered character screen; learned payload is only truth bits and source indices |
